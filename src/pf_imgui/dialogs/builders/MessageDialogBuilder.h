...
#ifndef PF_IMGUI_DIALOGS_BUILDERS_MESSAGEDIALOGBUILDER_H
#define PF_IMGUI_DIALOGS_BUILDERS_MESSAGEDIALOGBUILDER_H
...
#endif  //PF_IMGUI_DIALOGS_BUILDERS_MESSAGEDIALOGBUILDER_H
