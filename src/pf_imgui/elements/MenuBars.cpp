...
WindowMenuBar::WindowMenuBar(WindowMenuBar::Config &&config) : ElementWithID(config.name.value) {}
...
AppMenuBar::AppMenuBar(AppMenuBar::Config &&config) : ElementWithID(config.name.value) {}
