...
void LinearLayout::pushChild(std::unique_ptr<ElementBase> child) { children.emplace_back(std::move(child)); }

void LinearLayout::insertChild(std::unique_ptr<ElementBase> child, std::size_t index) {
