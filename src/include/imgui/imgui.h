...
#define IMGUI_HAS_STACK_LAYOUT      1 // Stack-Layout PR #846 // NOTE: added from PR
...
enum ImGuiStyleVar_
{
    ...
    ImGuiStyleVar_LayoutAlign,         // float     LayoutAlign // NOTE added from PR
    ImGuiStyleVar_COUNT
};
...
struct ImGuiStyle
{
    ...
    float       LayoutAlign;                // ElementWithID alignment inside horizontal and vertical layouts (0.0f - left/top, 1.0f - right/bottom, 0.5f - center). // NOTE added from PR
...
struct ImColor
{
    ...
    constexpr inline operator ImVec4() const                                  { return Value; }
